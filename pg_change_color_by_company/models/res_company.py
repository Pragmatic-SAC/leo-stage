...
class ResCompany(models.Model):
    ...
    def _default_background_image(self):
        image_path = get_module_resource('pg_change_color_by_company', 'static/src/img', 'transparent.png')
        return base64.b64encode(open(image_path, 'rb').read())

    background_image = fields.Binary(string="Home Background Image", attachment=True)

    @api.model
    def check_background(self, company_id):
